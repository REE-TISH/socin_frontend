  ...
  return (
    ...
    <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/create-chapter/:novel_id/:novel_name/' element={<CreateChapter2/>}/> {/*Create Chapter */}
          <Route path='/novel/:novel_id/' element={<NovelDetail/>}/> {/*Opens Detailed Novel Page of Each novel */} 
